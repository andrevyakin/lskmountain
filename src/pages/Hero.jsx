...
const Hero = () => {
  return (
    <>
      <div id="hero" className='bg-[url(/bg_mountain.png)] bg-no-repeat bg-cover bg-[#222222]'>
        {/*для 4-х элементов*/}
        <div className='h-dvh flex flex-col justify-evenly mx-16 px-44 border-x border-[#F0F0F0]'>

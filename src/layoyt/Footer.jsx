      ...
      <div className='bg-[url(/bg_mountain_10.png)] bg-no-repeat bg-cover backdrop-opacity-10'>
        <div className='flex flex-wrap'>
          ...
          <div className='w-1/2 p-10 h-fit justify-items-center mt-6'>
            <div className='border-b-[2px] w-fit font-prata text-center text-[#f0f0f0] text-7xl -mt-8 font-medium tracking-wider uppercase'>
              контакты
            </div>
            <p className='mt-4 font-philosopher text-center text-[#f0f0f0] whitespace-pre text-2xl'>

        ...
        <div className='bg-[rgba(0,0,0,.25)]'>
          <div className='flex flex-col-reverse sm:flex-row'>
            ...
            <article className='w-full sm:w-1/2  mt-4 py-4' ref={ref}>
              ...
              <p className='mt-6 sm:mt-6 font-philosopher text-center text-light text-sm/6 sm:text-sm md:text-sm/6 lg:text-base/7 xl:text-xl/9 2xl:text-2xl/10 sm:mb-2'>
                +7 (959) 222 22-22
                <br />
                ooolsklpr@mail.ru
                <br />

        ...
        <header className={`fixed top-0 w-full z-10 bg-[#323232] text-[#F0F0F0]`}>
          ...
          <nav className="relative sm:hidden bg-[#1e1e1e] h-16 w-full border-b-2 border-[#f0f0f0]">
            ...
            <img
              ...
              className="absolute h-5 w-auto right-0 top-1/2 -translate-x-1/2 -translate-y-1/2 cursor-pointer"
            />
          </nav>
          {mobileNav && (
            <>
              <div className="h-dvh bg-[#1e1e1e]">
                <div
                  className="h-11/12 border-2 border-t-0 border-[#f0f0f0] bg-[url(/bg_mountain_10.png)] bg-no-repeat bg-cover bg-top mx-5 mb-5">
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      >
                        <div className="flex flex-col items-center">
                          <LiaPhoneSolid className="text-3xl" />
                          <p className="text-2xl">+7 (959) 222 22-22</p>
                        </div>
                      </a>
                      <a
                        href="mailto:ooolsklpr@mail.ru"
                      ...
                      >
                        <div className="flex flex-col items-center">
                          <VscMail className="text-3xl" />
                          <p className="text-2xl">ooolsklpr@mail.ru</p>
                        </div>
                      </a>
                    </div>
                    <nav className="flex flex-col items-center gap-16 text-5xl uppercase">
                      <Link to="hero" offset={0} onClick={() => setMobileNav(!mobileNav)}>
                        главная
                      </Link>
                      <div className="flex flex-col items-center gap-2 text-3xl">
                        <Link to="products" offset={32} onClick={() => setMobileNav(!mobileNav)} className="text-5xl">
                          продукция
                        </Link>
                        <FaArrowDown />
                        <Link to="a" offset={-32} onClick={() => setMobileNav(!mobileNav)}>
                          щебень
                        </Link>
                        <Link to="b" offset={-32} onClick={() => setMobileNav(!mobileNav)}>
                          щпс
                        </Link>
                        <Link to="c" offset={-32} onClick={() => setMobileNav(!mobileNav)}>
                          отсев
                        </Link>
                      </div>
                      <Link to="contacts" offset={32} onClick={() => setMobileNav(!mobileNav)}>
                        о нас
                      </Link>
                    </nav>
                  </div>
